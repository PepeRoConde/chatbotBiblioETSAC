...
class MistralRAGSystem:
    ...
    def __init__(
        ...
        if self.verbose:
            self.log(f"RAG system initialized with Mistral API using model: {model_name}", "success")
...
Respuesta:""",
            "galician": """Usa a seguinte informacion para responder á pregunta. Se conciso, extrae informacion importante do texto. A resposta debe ser agradable e clara.
